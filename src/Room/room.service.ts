...
@Injectable()
@AddBasicService()
export class RoomService extends BasicServiceDummyAbstract<Room> implements IBasicService<Room> {
    ...
    public async handleUpdate(@Body() body: UpdateRoomDto) {
        ...
        if (body.roomItemsToRemove)
            body["roomItems"] =  deleteArrayElements(roomToUpdate.data[roomToUpdate.metaData.dataKey].roomItems, body.roomItemsToRemove);
