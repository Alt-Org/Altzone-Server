...
@Injectable()
export class isCustomCharacterExists
  extends isEntityExists<CustomCharacter>
  implements ValidatorConstraintInterface
{
  public constructor(
    @InjectModel(ModelName.CUSTOM_CHARACTER)
    private readonly model: Model<CustomCharacter>,
  ) {
