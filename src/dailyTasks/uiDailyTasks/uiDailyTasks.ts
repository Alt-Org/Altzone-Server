...
export const uiDailyTasks: Record<UITaskName, UIDailyTaskData> = {
    [UITaskName.FIND_3_IMPORTANT_BUTTONS]: {
        title: {fi: "etsi käyttöliittymän kannalta mielestäsi 3 tärkeintä painiketta"},
    ...
    [UITaskName.PRESS_STORY_MOST_IMPRESSIVE_PANELS]: {
        title: {fi: "TUNNETEHTÄVÄ > klikkaa alkutarinasta sinusta vaikuttavinta ruutua"},
    ...
    [UITaskName.PRESS_STORY_EXPANDING_OBJECTS]: {
        title: {fi: "etsi ja klikkaa pelin tarinaa laajentavia asioita nettisivuilta"},
    ...
    [UITaskName.PRESS_FAMOUS_THINGS_REFERRING_OBJECTS]: {
        title: {fi: "klikkaa tunnettuihin teoksiin, ideoihin tai ihmisiin viittaavia asioita"},
    ...
    [UITaskName.PRESS_OTHER_GRAPHIC_STYLE_ELEMENTS]: {
        title: {fi: "etsi ja klikkaa graafisia elementtejä, jotka viittaavat muihin taiteenlajeihin"},
    ...
    [UITaskName.CHANGE_LANGUAGE]: {
        title: {fi: "katso kieliasetukset ja klikkaa kohtia jotka muuttuvat eri kielien välillä"},
    ...
    [UITaskName.USE_ONLY_POSITIVE_GESTURES_IN_BATTLE]: {
        title: {fi: "käytä matsin aikana vain positiivisia ja kannustavia eleitä"},
    ...
    [UITaskName.PRESS_PRIZE_GIVING_ITEMS]: {
        title: {fi: "tunnista ja paina kohtia, joissa peli palkitsee sinua jotenkin"},
