...
describe('AuthService.signIn() test suite', () => {
    ...
    it('Should return access token, expiration time, profile, player and clan data if username and password are valid', async () => {
        ...
        const player = playerBuilder.setProfileId(existingProfile._id).setClanId(createdClanDB._id).build();
        ...
        const playerDBFinal = {
            ...
            gameStatistics: { ...clearedPlayer.gameStatistics, objectType: 'GameStatisticsDto', participatedVotings: undefined },
