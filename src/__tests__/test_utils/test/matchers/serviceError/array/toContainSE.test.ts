...
describe('toContainSE() test suite', () => {
    ...
    it('Should throw TypeError if the expected value is not array with SEReasons', () => {
        ...
        expect(() => passJestThis(toContainSE)(receivedErrors, ['not reason', 34])).toThrow(new TypeError("The expected value must be array of SEReasons"));
    });
