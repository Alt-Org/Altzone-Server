...
describe('ClanService.createOne() test suite', () => {
  ...
  it('Should generate different passwords for multiple closed clans', async () => {
    const c1 = ClanBuilderFactory.getBuilder('CreateClanDto')
      .setIsOpen(false)
      .build();
    const c2 = ClanBuilderFactory.getBuilder('CreateClanDto')
      .setIsOpen(false)
      .build();
  ...
  it('Should not generate a password for open clans', async () => {
    const openClan = ClanBuilderFactory.getBuilder('CreateClanDto')
      .setIsOpen(true)
      .build();
