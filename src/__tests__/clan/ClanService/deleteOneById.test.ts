...
describe('ClanService.deleteOneById() test suite', () => {
    ...
    beforeEach(async () => {
        ...
        const playerUpdate = playerUpdateBuilder.setClanId(existingClan._id).build();
    ...
    it('Should delete the object from DB if the _id is valid and return true', async () => {
        const [wasDeleted, errors] = await clanService.deleteOneById(existingClan_id);
    ...
    it('Should return ServiceError NOT_FOUND if the object with provided _id does not exist', async () => {
        ...
        const [wasDeleted, errors] = await clanService.deleteOneById(nonExisting_id);
    ...
    it('Should not throw any error if input _id is null or undefined', async () => {
        ...
        const undefinedInput = async () => await clanService.deleteOneById(undefined);
