...
describe('BoxService.deleteBox() test suite', () => {
  ...
  it('Should return true if all box related data was removed', async () => {
    ...
    const [isRemoved, errors] = await boxService.deleteBox(box._id);
  ...
  it('Should delete all box related clans from DB', async () => {
    ...
    await boxService.deleteBox(box._id);
  ...
  it('Should delete box from DB', async () => {
    await boxService.deleteBox(box._id);
  ...
  it('Should delete admin group from DB', async () => {
    await boxService.deleteBox(box._id);
  ...
  it('Should delete admin group player from DB', async () => {
    ...
    expect(adminPlayerInDB).toBeNull();
  });
  ...
  it('Should delete admin group profile from DB', async () => {
    ...
    expect(adminProfileInDB).toBeNull();
  });
  ...
  it('Should return ServiceError NOT_FOUND if there are no box with this _id', async () => {
    const [isReset, errors] = await boxService.deleteBox(getNonExisting_id());
  ...
  it('Should return ServiceError REQUIRED if the box_id is null', async () => {
    const [isReset, errors] = await boxService.deleteBox(null);
  ...
  it('Should return ServiceError REQUIRED if the box_id is undefined', async () => {
    const [isReset, errors] = await boxService.deleteBox(undefined);
  ...
  it('Should return ServiceError REQUIRED if the box_id is empty string', async () => {
    const [isReset, errors] = await boxService.deleteBox('');
