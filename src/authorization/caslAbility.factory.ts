...
export type AllowedSubject =
  ...
  | typeof PlayerDto
  | typeof UpdatePlayerDto
  | typeof CustomCharacterDto
  | typeof UpdateCustomCharacterDto
  | typeof CharacterClassDto
  | typeof UpdateCharacterClassDto
  | typeof ItemDto
  | typeof UpdateItemDto
  | typeof StockDto
  | typeof UpdateStockDto
  | typeof ClanDto
  | typeof UpdateClanDto
  | typeof JoinDto
  | typeof JoinResultDto
  | typeof PlayerLeaveClanDto
  | typeof RemovePlayerDTO
  | typeof SoulHomeDto
...
export type AppAbility = MongoAbility<
  [AllowedAction | Action.manage, Subjects | 'all']
>;
...
export class CASLAbilityFactory {
  ...
  public createForUser = async (
    ...
    if (
      isType(obj, 'CustomCharacterDto') ||
      isType(obj, 'UpdateCustomCharacterDto')
    )
      return customCharacterRules(
        user,
        subject,
        action,
        subjectObj,
    ...
    if (
      obj instanceof CharacterClassDto ||
      isType(obj, 'CharacterClassDto') ||
      isType(obj, 'UpdateCharacterClassDto')
    )
