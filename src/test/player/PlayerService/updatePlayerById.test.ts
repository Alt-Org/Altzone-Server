...
describe('PlayerService.updatePlayerById() test suite', () => {
    ...
    it('Should update player in the DB and return true if the input is valid', async () => {
        ...
        const [wasUpdated, errors] = await playerService.updatePlayerById(existingPlayer._id, updateData);
    ...
    it('Should return ServiceError NOT_FOUND if player with the provided _id does not exist', async () => {
        ...
        const [wasUpdated, errors] = await playerService.updatePlayerById(nonExisting_id, updateData);
    ...
    it('Should not throw any error if _id or input is null or undefined', async () => {
        const nullInput = async () => await playerService.updatePlayerById(null, null);
        const undefinedInput = async () => await playerService.updatePlayerById(undefined, undefined);
