...
describe("ChatService.readAllMessages() test suite", () => {
    ...
    beforeEach(async () => {
        ...
        const chat = await chatService.createOne(chatToCreate) as IResponseShape<Chat, object>;
    ...
    it("Should return paginated messages", async () => {
        ...
        const query: IGetAllQuery = { filter: {}, sort: { id: 1 }, limit: 1, skip: 0 };
        const messages = await chatService.readAllMessages(chatId, query) as IResponseShape<Chat>;
    ...
    it("Should return all messages in the chat", async () => {
        ...
        const query: IGetAllQuery = { filter: {}, sort: { id: 1 }, limit: 10, skip: 0 };
        const messages = await chatService.readAllMessages(chatId, query) as IResponseShape<Chat>;
    ...
    it("Should return an empty array if no messages match the filter", async () => {
        const query: IGetAllQuery = { filter: { senderUsername: "nonExistentUser" }, sort: { id: 1 }, limit: 10, skip: 0 };
        const messages = await chatService.readAllMessages(chatId, query) as IResponseShape<Chat>;
