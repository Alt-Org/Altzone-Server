 ...
 */
export const toEqualSE: MatcherFunction<[expected: SEReason[]]> = function (object, expected) {
    ...
    if(object.length !== expected.length)
        return returner.passFalse('Received array contains less items than expected');
