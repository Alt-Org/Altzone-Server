 ...
 */
export const toBeSE_LESS_THAN_MIN: MatcherFunction<[object: any]> = function(object) {
    ...
    return isValid ?
        returner.passTrue('Expected to not receive a ServiceError with reason LESS_THAN_MIN') :
        returner.passFalse('Expected to receive ServiceError with reason LESS_THAN_MIN');
}
